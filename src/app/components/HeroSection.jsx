    ...
    <section className='lg:py-16'>
        <div className='grid grid-cols-1 sm:grid-cols-12'>
            <motion.div initial={{opacity: 0, scale: 0.5}} animate={{opacity: 1, scale: 1}} transition={{duration: 0.5}} className='col-span-8 place-self-center text-center sm:text-left justify-self-start'>
                ...
                <p className='text-[#ADB7BE] text-base sm:text-lg lg:text-x'>Dedicated and enthusiastic undergraduate student majoring in Informatics, with a strong passion for front-end development</p>
                <div className='mt-6'>
